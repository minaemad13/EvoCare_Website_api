"""
Django settings for EvoCare_Website_api project.
...
SECRET_KEY = 'django-insecure-!^f2ot^_+g!g9$0j@eb8hvhcw+63*hth0=#wo*+2x#45sx95x$'
...
WSGI_APPLICATION = 'EvoCare_Website_api.wsgi.application'
